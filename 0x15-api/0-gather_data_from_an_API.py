...
if __name__ == "__main__":
    ...
    t_link = requests.get("https://jsonplaceholder.typicode.com/user/{}/todos".format(num))
    t_link_data = t_link.json()
    ...
    print("Employee {} is done with tasks({}/{}):".format(r_user, lengh, t_lengh))
    for i in task:
        print("\t {}".format(i))